              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  {
                    sbyte _key26;
                    CumulativeAmount _val27;
                    _key26 = iprot.ReadByte();
                    _val27 = new CumulativeAmount();
                    _val27.Read(iprot);
                    BalancePerCurrency[_key26] = _val27;
                  }
                  iprot.ReadMapEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (BalancePerCurrency != null && __isset.balancePerCurrency) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (sbyte _iter28 in BalancePerCurrency.Keys)
            {
              oprot.WriteByte(_iter28);
              BalancePerCurrency[_iter28].Write(oprot);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();

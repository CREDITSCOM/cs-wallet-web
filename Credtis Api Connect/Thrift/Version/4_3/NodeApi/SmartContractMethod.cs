              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    SmartContractMethodArgument _elem68;
                    _elem68 = new SmartContractMethodArgument();
                    _elem68.Read(iprot);
                    Arguments.Add(_elem68);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (Arguments != null && __isset.arguments) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SmartContractMethodArgument _iter69 in Arguments)
            {
              _iter69.Write(oprot);
            }
            oprot.WriteListEnd();

...
namespace NodeApi
{
  public partial class API {
    public interface ISync {
      ...
      TokensListResult TokensListGet(long offset, long limit, TokensListSortField order, bool desc);
    ...
    public interface Iface : ISync {
      ...
      #endif
      #if SILVERLIGHT
      IAsyncResult Begin_TokensListGet(AsyncCallback callback, object state, long offset, long limit, TokensListSortField order, bool desc);
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_TokensListGet(AsyncCallback callback, object state, long offset, long limit, TokensListSortField order, bool desc)
      {
        return send_TokensListGet(callback, state, offset, limit, order, desc);
      }
      ...
      public TokensListResult TokensListGet(long offset, long limit, TokensListSortField order, bool desc)
      {
        #if !SILVERLIGHT
        ...
        #else
        var asyncResult = Begin_TokensListGet(null, null, offset, limit, order, desc);
        return End_TokensListGet(asyncResult);

        #endif
      }
      #if SILVERLIGHT
      public IAsyncResult send_TokensListGet(AsyncCallback callback, object state, long offset, long limit, TokensListSortField order, bool desc)
      #else
      public void send_TokensListGet(long offset, long limit, TokensListSortField order, bool desc)
      #endif
      {
    ...
    public class Processor : TProcessor {
      ...
      public void TokensListGet_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        try
        {
          result.Success = iface_.TokensListGet(args.Offset, args.Limit, args.Order, args.Desc);
                ...
                if (field.Type == TType.List) {
                  {
                    ...
                    {
                      ByteCodeObject _elem113;
                      _elem113 = new ByteCodeObject();
                      _elem113.Read(iprot);
                      ByteCodeObjects.Add(_elem113);
                    }
                    iprot.ReadListEnd();
                  }
                } else { 
        ...
        try
        {
          ...
          if (ByteCodeObjects != null && __isset.byteCodeObjects) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (ByteCodeObject _iter114 in ByteCodeObjects)
              {
